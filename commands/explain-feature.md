...
Apply the skill's audience detection, complexity level handling, analogy generation, merge request mode, ticket mode, glossary rules, and required nine-section output format.
